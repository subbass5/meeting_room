...
?>
	<?php 
		$res1=mysql_query("SELECT meeting.title,meeting.date_time_start,meeting.date_time_end,users.name FROM meeting,users WHERE meeting.user_id = users.user_id and meeting.room_id = $id and meeting.date_time_start like '%$eng_date1%' 
